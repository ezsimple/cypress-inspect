...
describe('마이페이지 - 메세지', () => {
  ...
  it('', () => {
    const q = 0;
    const url = '';
    // DELETE /api/v1/member/message/all 전체 메세지 삭제
    const req = {};
  ...
  it('', () => {
    const q = 0;
    const url = '';
    // GET /api/v1/member/message/all 전체 메세지 조회
    const req = {};
    get(token, url, null).should((response) => {
      expect(response.status).to.eq(200);
      console.log(prettyJSON(response));
  ...
  it('', () => {
    const q = 0;
    const url = '';
    // DELETE /api/v1/member/message/celeb 셀럽 별 메세지 삭제
    const req = {};
    get(token, url, null).should((response) => {
      expect(response.status).to.eq(200);
      console.log(prettyJSON(response));
  ...
  it('', () => {
    const q = 0;
    const url = '';
    // GET /api/v1/member/message/celeb 셀럽 별 메세지 조회
    const req = {};
    get(token, url, null).should((response) => {
      expect(response.status).to.eq(200);
      console.log(prettyJSON(response));
  ...
  it('', () => {
    const q = 0;
    const url = '';
    // DELETE /api/v1/member/message/{memberMessageIndex} 단건 메세지 삭제
    const req = {};
    get(token, url, null).should((response) => {
      expect(response.status).to.eq(200);
      console.log(prettyJSON(response));
